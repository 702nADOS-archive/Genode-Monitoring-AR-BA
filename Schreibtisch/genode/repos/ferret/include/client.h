...
#define \
    ferret_create(major, minor, instance, type, flags, config, addr) \
    ferret_create_sensor((major), (minor), (instance), (type), (flags),     \
                         (config), (void **)&(addr))
 ...
 */
L4_CV int ferret_create_sensor(uint16_t major, uint16_t minor,
